...
https://console.firebase.google.com/project/NexCoin-app/firestore/rules
...
⚠️ IMPORTANTE: Use as regras completas do arquivo, não este texto resumido!`;
  ...
  const openFirebaseConsole = () => {
    window.open('https://console.firebase.google.com/project/NexCoin-app/firestore/rules', '_blank');
  };
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-3">
                ...
                <div className="flex-1">
                  ...
                  >
                    console.firebase.google.com/project/NexCoin-app/firestore/rules
                  </button>
                </div>
              </div>
