                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-5 gap-12 mb-20">
                            <div className="col-span-2">
                                ...
                                <div className="mt-8 space-y-2 text-sm text-gray-500 font-medium">
                                    <p>{t.landingPage.footerAddress}</p>
                                    <p>{t.landingPage.footerPhone}</p>
                                    <a href={`mailto:${t.landingPage.footerEmail}`} className="hover:text-blue-600 transition-colors">{t.landingPage.footerEmail}</a>
                                </div>
                            </div>
