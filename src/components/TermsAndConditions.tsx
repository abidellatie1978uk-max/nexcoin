      ...
      <div className="px-6 pb-24 space-y-6">
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-gray-400 leading-relaxed">
            Ao acessar e usar o NexCoin, você concorda em cumprir estes Termos de Uso. Se você não concordar com qualquer parte destes termos, não deverá usar nossos serviços.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-gray-400 leading-relaxed">
            Você deve ter pelo menos 18 anos de idade para usar o NexCoin. Ao criar uma conta, você declara e garante que tem capacidade legal para celebrar este contrato.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <div className="space-y-2 text-sm text-gray-400">
            ...
            <p className="leading-relaxed">
              • O NexCoin não será responsável por perdas decorrentes do uso não autorizado de sua conta
            </p>
          </div>
        </section>
        ...
        <section className="space-y-3">
          ...
          <div className="space-y-2 text-sm text-gray-400">
            <p className="leading-relaxed">
              <strong className="text-white">Uso Permitido:</strong> O NexCoin é uma plataforma para negociação de criptomoedas. Você concorda em usar a plataforma apenas para fins legais.
            </p>
            <p className="leading-relaxed">
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-gray-400 leading-relaxed">
            Todas as transações realizadas através do NexCoin estão sujeitas a taxas de rede. As taxas são claramente exibidas antes da confirmação de qualquer transação. Uma vez confirmada, a transação é irreversível.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-gray-400 leading-relaxed">
            Você reconhece que o mercado de criptomoedas é volátil e que o valor dos seus ativos pode flutuar significativamente. O NexCoin não garante lucros e você é responsável por suas decisões de investimento.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-gray-400 leading-relaxed">
            O NexCoin não será responsável por perdas diretas, indiretas, incidentais ou consequenciais resultantes do uso ou incapacidade de usar nossos serviços, incluindo perda de fundos, dados ou lucros.
          </p>
        </section>
        ...
        <div className="bg-zinc-900 rounded-2xl p-4 mt-8">
          <p className="text-xs text-gray-400 text-center">
            Ao usar o NexCoin, você concorda com estes Termos de Uso
          </p>
        </div>
      </div>
    </div>
